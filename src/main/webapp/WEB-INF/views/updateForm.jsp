...
<!-- ---------------------------------------------------------------------------------------------- -->
  ...
  <!-- Page Content -->
	<form class="_passwordConfirmForm" action="/login/userModify.pang" method="post" id="fr">
            <input id="confirmTicket" name="confirmTicket" value="" type="hidden">
            <h1>회원정보 확인</h1>
                정보를 안전하게 보호하기 위해 비밀번호를 다시 한번 확인 합니다.<br><br><br>
            <div>
				<input type="text" value="아이디" name="id" readonly="readonly" >
			...
			<div class="home_btns m-top-40">
                <a href="" class="btn btn-primary m-top-20" tabindex="-1">Buy Now</a>
                <a href="" class="btn btn-default m-top-20" tabindex="-1">Take a Tour</a>
                  </div>
        </form>
<!-- ---------------------------------------------------------------------------------------------- -->
